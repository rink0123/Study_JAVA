...
/**
 * <h3>if, if-else, if-else if-else문(The if-then and if-then-else Statements)</h3>
 * 
 * <h4>참고 사이트</h4>
 * <ul>
...
public class ConditionalStatements {
	 ...
	 * 
	 * 삼항 연산자에 의한 조건문
	 * 1.1. 간단한 if-else문은 삼항 연산자를 이용하여 간결하게 표현할 수 있다.
	 * 1.2. 조건식 ? 반환값1 : 반환값2
	 */
	public static void main(String[] args) {
		/*
		 * 백준 알고리즘-단계별로 풀어보기-if_두 수 비교하기(1330번).
		...
		/*
		 * 백준 알고리즘-단계별로 풀어보기-if_시험 성적(9498번).
		...
		/*
		 * 백준 알고리즘-단계별로 풀어보기-if_사분면 고르기(14681번).
		...
		/*
		 * 백준 알고리즘-단계별로 풀어보기-if_알람 시계(2884번).
